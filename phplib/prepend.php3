...
$_PHPLIB["libdir"]  = "/home/user/danzj000/phplib/";
...
require($_PHPLIB["libdir"] . "additional/init.inc");
require($_PHPLIB["libdir"] . "additional/plm_member.inc");
require($_PHPLIB["libdir"] . "additional/icon.inc");
require($_PHPLIB["libdir"] . "additional/db_handler.inc");
require($_PHPLIB["libdir"] . "additional/clientapli.inc");
require($_PHPLIB["libdir"] . "additional/link_info.inc");
