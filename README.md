...
人間関係をWeb上に地図化してみようという試み。ここにあるソースコードは2002年頃に開発したもの。友人のアイデアを技術面でサポートする形で開発に参加。
...
本ソースコードは **p-linkmap プロジェクト関係者一同の共同著作物** です。

利用・改変・再配布の際は、p-linkmap のソースコードを参考・流用した旨のクレジット表記が必要です。  
詳細は [LICENSE.md](LICENSE.md) を参照してください。

> このプロジェクトに関わってくれたすべての人へ、感謝をこめて。
